...
for ibin in range(1, nbins+1):
    ...
    if reweight_hist.GetBinContent(ibin) == 0: 
        ...
        weights.append(1.)
        continue
    weights.append(data_hist.GetBinContent(ibin) / reweight_hist.GetBinContent(ibin))
    errw.append( sqrt(  (1/reweight_hist.GetBinContent(ibin))**2 * data_hist.GetBinError(ibin)**2  \
